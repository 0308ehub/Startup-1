-- Create cards table with exact column names matching the CSV
-- Run this in your Supabase SQL Editor

-- Drop the existing cards table if it exists
DROP TABLE IF EXISTS cards CASCADE;

-- Recreate the cards table with exact CSV column names
CREATE TABLE cards (
